...
from python.etl.parse_kdata1 import parse_kdata1_source_files
...
def main() -> None:
    ...
    inserted_rows = parse_kdata1_source_files(engine)
    print(f"KDATA1 parsing complete. inserted_raw_observation_rows={inserted_rows}")
