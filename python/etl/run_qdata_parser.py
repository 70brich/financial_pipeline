...
from python.etl.parse_qdata import parse_qdata_source_files
...
def main() -> None:
    ...
    inserted_rows = parse_qdata_source_files(engine)
    print(f"QDATA parsing complete. inserted_raw_observation_rows={inserted_rows}")
